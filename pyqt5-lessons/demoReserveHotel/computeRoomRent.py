...
class MyForm(QDialog):
    ...
    def computeRoomRent(self):
        ...
        self.ui.Enteredinfo.setText('Date of reservation: ' + dateinstring + ', Number of days: ' + str(noOfDays) + 'and Room type selected: '+ chosenRoomType)
        roomRent=0
        ...
        self.ui.RoomRentinfo.setText('Room Rent for singleday for ' + chosenRoomType + ' type is $' + str(roomRent)+ '. Total room rent is $' + str(total)+' ')
